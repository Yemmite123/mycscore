  ...
  <app-header></app-header> 
    <div style="margin-bottom: 20%;"  class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <img class="container_dashboard img-fluid" src="../assets/Group 582.png" alt="">
            </div>
        </div>
    </div>
           ...
           <center> 
            ...
            <div class="row row-cols-1 row-cols-md-2">
                <div class="col mb-4">
                    ...
                    <div class="container card_sec">
                      <div class="row">
                            <div class="col-md-12">
                              <h4 class="">Credit Scoring</h4>
                            <div style="float:right" class="icons1">
                                <span class="flaticon-qualifications"></span>
                            </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="card card1">
                  ...
                  <div class="card-body">
                    ...
                    <div class="container card_sec">
                        <div class="row">
                            <div class="col-md-12">
                              <h4 class="">Credit Analytics/<br>Reporting</h4>
                              <div style="float:right" class="icons2">
                              <span class="flaticon-insight"></span>
                            </div>
                          </div>
                        </div>    
                    </div>
                 ...
                 <div class="col mb-4">
                    ...
                    <div class="container card_sec">
                       <div class="row">
                            <div class="col-md-12">
                              <h4 class="">Artificial Intelligence <br>as a service</h4>
                              <div style="float:right" class="icons2">
                 ...
                 <div class="col mb-4">
                    ...
                    <div class="container card_sec">
                      <div class="row">
                            <div class="col-md-12">
                              <h4 class="">Risk <br>Management</h4>
                              <div style="float:right" class="icons2">
                              <span class="flaticon-equivalence"></span>
                            </div>
                          </div>
                        </div>  
                      </div>
...
<div class="container-fluid why_use_mycs">
 <div class="row">
     <div class="jumbo"> 
    <!--Section: Content-->
    <section class="px-md-5 mx-md-5 text-center white-text">
      <!--Grid row-->
...
<div style="background: #F1F3F6 0% 0% no-repeat padding-box; padding-bottom: 8%; padding-top: 8%;" class="container-fluid">
  <div class="container">
    ...
    <section class="text-left py-5">

      <p class="mb-4 pb-2 customer">Working with Companies like:</p>
  ...
  <div style="margin-top: 8%;" class="container">
    <h2 class="text-center frequently">Frequently Asked Questions</h2>
    <p class="text-center frequently_para">Have a question?, We’ve got answers!</p>
    <div id="accordion">
      <div style=" margin-bottom: 2%;" class="card">
        <div class="card-header faq_card">   <br>
          <a  class="card-link" data-toggle="collapse" href="#collapseOne">
            What exactly is MyCScore? <span class="float-right faq_icon">  <img src="../assets/plus.svg" class="img-fluid " alt="Logo"></span>
          </a>
        </div>
...
<style scoped>
.bodyBack{
      background: url("../assets/backgroundscore.png");
...
.card1{
    height: 100%;
    background: #E9EBF2 0% 0% no-repeat padding-box;
    border-radius: 16px;
    color: #1A2384;
}
.card1:hover {
    background: #1A2384 0% 0% no-repeat padding-box;
    border-radius: 16px;
    color: #ffffff; 
}
.card_sec{
